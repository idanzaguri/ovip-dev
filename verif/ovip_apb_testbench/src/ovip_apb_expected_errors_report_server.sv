`ifndef OVIP_APB_EXPECTED_ERRORS_REPORT_SERVER__SV
`define OVIP_APB_EXPECTED_ERRORS_REPORT_SERVER__SV

// Custom UVM report server used by ovip_apb_base_test. Tests register
...
class ovip_apb_expected_errors_report_server extends uvm_default_report_server;
